  ...
  return (
    <div>
      <p>
        ...
        share of water in rivers, lakes and aquifers is taken for human use.
        Water becomes scarce because increasing water use makes it difficult to
        satisfy various competing human and environmental needs.{' '}
